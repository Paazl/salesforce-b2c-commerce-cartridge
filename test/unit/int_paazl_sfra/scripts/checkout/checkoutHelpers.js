...
var baseCheckoutHelpers = require('../../../../../../storefront-reference-architecture/test/mocks/helpers/checkoutHelpers');
...
describe('checkoutHelpers', function () {
    before(function () {
        ...
        checkoutHelpers = require('../../../../mocks/helpers/checkoutHelpers');
    });
